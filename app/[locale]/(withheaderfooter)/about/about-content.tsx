...
export default function AboutContent() {
    ...
    return (
        <div className="flex flex-col gap-8 md:gap-12 md:mt-30 lg:mt-16 justify-start items-start">
            ...
            {/* New lead-in text and FAQ button */}
            <p className="text-[1rem] my-5 md:text-[1.5rem] text-[#575757]">
                {t('faq_lead')}
            </p>
            <ActionButton
                backgroundColor={'#B6CF54'}
                textColor={'#ffffff'}
                // If you have an ID for your FAQ on the contact page, you could use `#faq`.
                // Otherwise, just link to `/${localActive}/contact`.
                href={`/${localActive}/contact#faq`}
            >
                {t('faq_button')}
            </ActionButton>
        </div>
