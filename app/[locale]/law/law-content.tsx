    ...
    return (
        <div className='flex flex-col gap-8 md:gap-12 md:mt-30 lg:mt-16'>
            ...
            <p className='md:text-[1.2rem] text-[#2E2E2E] md:max-w-[500px]'>
                {t("headline_description")} <a href="https://www.bundesgesundheitsministerium.de/themen/cannabis/faq-cannabisgesetz#:~:text=Das%20Inkrafttreten%20der%20Regelungen%20zu,dahin%20bleibt%20Cannabis%20weiterhin%20verboten.">Click here.</a>
            </p>
            ...
            <h2 className='font-bold text-1xl'>1. {t("term_one_title")}</h2>
                ...
                <p>{t("term_six")}</p>
                <h2 className='font-bold text-1xl'>7. {t("term_seven_title")} </h2>
                <p>{t("term_seven")}</p>
            </div>
        </div>
    );
