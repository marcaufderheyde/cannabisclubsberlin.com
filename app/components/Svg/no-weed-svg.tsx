export default function NoWeedSVG({
    color,
    className,
}: {
    color: string;
    ...
    return (
        ...
        >
            <path
                style={{ fill: color }}
                d='M400,67C216.09,67,67,216.09,67,400s149.09,333,333,333s333-149.09,333-333S583.91,67,400,67z M400,695.09
	...
	C695.09,496.29,648.96,581.82,577.6,635.68z'
            ...
            <path
                style={{ fill: color }}
                d='M213.92,445.14c4.9-11.06,62.74,3.37,111.41,22.45c-2.03-3.19-4.03-6.49-6.09-9.97
