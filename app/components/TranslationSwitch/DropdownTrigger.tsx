...
import EnglishFlag from '@/app/components/EnglishFlag/EnglishFlag';
import GermanFlag from '@/app/components/GermanFlag/GermanFlag';
import LanguageCaret from '@/app/components/TranslationSwitch/LanguageCaret';
