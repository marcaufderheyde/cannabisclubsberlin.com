...
async function generate() {
    ...
    for (const lang of languages) {
        ...
        writeFileSync(path.join('sitemaps', `sitemap-${lang}.xml`), formatted); // Use path.join to construct file path
    }
    ...
    writeFileSync(path.join('sitemaps', `sitemap.xml`), formatted);
